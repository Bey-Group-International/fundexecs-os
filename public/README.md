...
## FundExecs OS character packs

The 16-bit character assets are generated by:
...
| Purpose | Source |
|---------|--------|
| Character Studio customizables pack | `assets/fundexecs/character-packs/customizables/studio-pack.png` |
| Earn + executive agents pack | `assets/fundexecs/character-packs/agents/executive-agent-pack.png` |
| Earn brand mark | `earn-coin.png`, `icon-192.png`, `icon-512.png` |
| Agent sprite sheets, HQ sprites, cards | `assets/fundexecs/characters/{slug}/` |
