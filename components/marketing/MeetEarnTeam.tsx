    ...
    >
      ...
      <div className="relative mx-auto mt-12 aspect-square w-full max-w-[560px]">
        ...
        <div className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center">
          <div className="relative h-24 w-24 overflow-hidden rounded-full border-2 border-gold-400/70 shadow-[0_0_30px_-6px_rgb(var(--fx-accent-rgb)/0.6)] sm:h-28 sm:w-28">
            <Image
              src={EARN_PHOTO}
        ...
        {NODES.map(({ agent, x, y }) => (
          ...
          >
            <span
              className="flex h-11 w-11 items-center justify-center rounded-full text-xs font-semibold text-surface-0 shadow-md ring-2 ring-surface-0 sm:h-14 sm:w-14 sm:text-sm"
      ...
      <div className="mx-auto mt-10 flex max-w-xl flex-wrap items-center justify-center gap-x-6 gap-y-2 border-t border-line/60 pt-6 font-mono text-[10px] uppercase tracking-wider text-fg-muted">
        <span>Sourcing</span>
