  ...
  if ((step === 'success' || step === 'already') && result) {
    ...
    return (
      <div style={{ width: '100%', maxWidth: 480, margin: '0 auto', textAlign: 'center' }}>
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--fg-3)', marginBottom: 12 }}>
            What happens next
          </div>
          {[
  ...
  return (
    ...
    >
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: '50%',
                  flexShrink: 0,
                  border: `2px solid ${roleGroup === r.id ? '#F7C948' : 'var(--border)'}`,
                  background: roleGroup === r.id ? '#F7C948' : 'transparent',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center'
                }}
              >
                {roleGroup === r.id && (
                  <span
                    style={{ width: 7, height: 7, borderRadius: '50%', background: '#070b14' }}
                  />
                )}
              </span>
              <div>
      ...
      <div>
        ...
        >
          Referral code <span style={{ color: 'var(--fg-5)' }}>(optional)</span>
        </label>
        <input
          type="text"
          value={referralCode}
      ...
      <button
        ...
        style={{
          ...
          background:
            step === 'submitting'
              ? 'rgba(247,201,72,0.5)'
              : 'linear-gradient(135deg,#F7C948,#E5A823)',
          color: '#070b14',
          border: 'none',
