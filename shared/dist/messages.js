...
exports.RoomOccupancySchema = zod_1.z.object({
    type: zod_1.z.literal("room.occupancy"),
    counts: zod_1.z.record(zod_1.z.string(), zod_1.z.number()),
});
