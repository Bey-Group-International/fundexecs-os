  ...
  public: {
    Tables: {
      ...
      airdrop_claims: {
        ...
        Relationships: [
          {
            foreignKeyName: 'airdrop_claims_waitlist_id_fkey';
            columns: ['waitlist_id'];
            isOneToOne: false;
      ...
      waitlist_signups: {
        Row: {
          ...
          airdrop_claimed_at: string | null;
    ...
    Enums: {
      ...
      org_type: 'fund' | 'lp' | 'operator' | 'capital_provider' | 'service_provider' | 'partner';
    };
    CompositeTypes: {
      [_ in never]: never;
    };
