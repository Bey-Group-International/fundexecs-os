      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-20 sm:px-6">
        <div className="fx-glass w-full max-w-sm p-5 sm:p-6">
          ...
          <div className="my-5 flex items-center gap-3">
            ...
            <span className="font-mono text-[11px] uppercase tracking-widest text-fg-muted">or</span>
            <span className="h-px flex-1 bg-line" />
          </div>
          ...
          {/* The queue is a sales path now, not the way in — so it sits below
              the self-serve route, not in place of it. */}
