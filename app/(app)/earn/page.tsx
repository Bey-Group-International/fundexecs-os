    ...
    <div className="fx-ambient mx-auto max-w-3xl">
      <header className="mb-6">
        ...
        <p className="mt-2 max-w-xl text-sm text-fg-secondary">
          ...
          <Link href="/earn/diligence" className="text-gold-300 hover:underline">
            Diligence Brain
          </Link>
          .
        </p>
      ...
      {asked && (
        <div className="mb-5 flex items-start gap-3 rounded-2xl border border-gold-500/25 bg-gold-500/[0.06] px-4 py-3">
          <span aria-hidden className="mt-0.5 text-gold-300">✦</span>
          <div className="min-w-0">
            <p className="font-mono text-[11px] uppercase tracking-wider text-gold-300">You asked Earn</p>
