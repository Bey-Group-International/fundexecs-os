...
type BriefResult = { ok: true } | { ok: false; error: string };
 ...
 */
export async function briefTheTeam(input: Mandate): Promise<BriefResult> {
  ...
  //    Mandate Brief stands in for the long Q&A; deeper profile editing comes
  //    back with the profile surfaces.
  const objLabel =
