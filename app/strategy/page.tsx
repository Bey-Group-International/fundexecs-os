...
/* ---- Mock data — shaped to mirror a `notifications` / objectives table ---- */

type Tier = '100' | '30' | '10';
type Priority = 'High' | 'Medium' | 'Low';
type ObjectiveState = 'open' | 'done' | 'archived';
...
const SEED: Objective[] = [
  {
    id: 'obj-1',
    tier: '100',
    title: 'Close $5M anchor LP commitment',
    timeline: 'Q3 2026',
    owner: 'A. Okafor',
    priority: 'High',
    pct: 40,
    read: false,
    state: 'open',
    ai: 'Advance proof of concept — upload revised thesis deck and schedule the IC review.'
  },
  {
    id: 'obj-2',
    tier: '100',
    title: 'Reach $57M Fund II final close',
    timeline: 'Q4 2026',
    owner: 'J. Avery',
    priority: 'High',
    pct: 72,
    read: true,
    state: 'open',
    ai: 'On pace. 3 soft-circles to convert — Earn drafted commitment-tracker nudges.'
  },
  {
    id: 'obj-3',
    tier: '30',
    title: 'Build institutional LP room',
    timeline: '30 days',
    owner: 'P. Mensah',
    priority: 'Medium',
    pct: 55,
    read: false,
    state: 'open',
    ai: 'Add DDQ and track-record memo to complete the investor-ready room.'
  },
  {
    id: 'obj-4',
    tier: '30',
    title: 'Stand up 7-agent diligence workflow',
    timeline: '30 days',
    owner: 'J. Avery',
    priority: 'Medium',
    pct: 60,
    read: true,
    state: 'open',
    ai: 'Synthesis agent ready once the red-flags agent clears 2 open items.'
  },
  {
    id: 'obj-5',
    tier: '10',
    title: 'Weekly synergy review cadence',
    timeline: 'This week',
    owner: 'Team',
    priority: 'Low',
    pct: 90,
    read: true,
    state: 'open',
    ai: 'Nearly there — confirm the Friday recurring slot to lock the habit.'
  },
  {
    id: 'obj-6',
    tier: '10',
    title: 'Complete operator profile & socials',
    timeline: 'This week',
    owner: 'J. Avery',
    priority: 'Low',
    pct: 100,
    read: true,
    state: 'done',
    ai: 'Done. +150 XP earned. Visibility unlocked across the network.'
  }
];
...
function ObjectiveCard({ o, onAct }: { o: Objective; onAct: (id: string, a: Action) => void }) {
      ...
      <div className="flex flex-col gap-[18px]">
        ...
        <Card className="flex items-center gap-4 bg-[linear-gradient(100deg,rgba(247,201,72,0.08),transparent_58%)] px-[18px] py-3.5">
          ...
          <div className="min-w-0 flex-1 text-[13px] text-fg-2">
            ...
            assistant, is tracking your plan — Fund II is on pace, but the{' '}
            <span className="font-semibold text-warning">anchor LP objective</span> is slipping with
            9 days to deadline.
          </div>
