-- Migration: Knowledge Synthesis Engine (Feature 05).
--
-- synthesis_queue tracks artifact accumulation per topic and drives
-- Claude-powered synthesis drafts for operator review and approval.
