...
insert into public.ai_agents (key, name, hub, role, color, motion_style, capabilities) values
  ...
  ('associate', 'Earn', null, 'Coordinates workflows and task execution across all hubs.', '#6366f1', 'coordinated, rhythmic', array['orchestration','routing','handoff','task_management']),
