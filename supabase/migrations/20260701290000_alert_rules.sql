-- Migration: Event-Triggered Smart Alerts (Feature 10).
--
-- Two tables:
--   alert_rules   — operator-configured threshold / change alert rules
--   alert_events  — immutable log of fired alerts, with acknowledgement tracking
