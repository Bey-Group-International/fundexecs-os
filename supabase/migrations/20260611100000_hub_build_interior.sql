...
--
-- fund_formations and formation_steps already ship in
-- 20260611200000_fund_formation.sql on main. This wave adds the remaining
-- BUILD interior governance tables without rewriting those shipped tables.
-- ============================================================================
